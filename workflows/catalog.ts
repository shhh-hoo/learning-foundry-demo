export const WORKFLOW_CATALOG = [
  ...
  { kind: "DIAGNOSIS", title: "Bounded Attempt interpretation and deterministic calculation check", nodes: ["prepare_attempt", "capture_attempt", "execute_capability"], interrupts: [] },
