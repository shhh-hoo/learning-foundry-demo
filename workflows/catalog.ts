export const WORKFLOW_CATALOG = [
  ...
  { kind: "GOVERNED_FOLLOWUP", title: "Governed Retry / Transfer / Retention", nodes: ["assign_followup", "learner_followup_interrupt", "teacher_result_interrupt"], interrupts: ["LEARNER_FOLLOWUP_REQUIRED", "FOLLOWUP_RESULT_REVIEW_REQUIRED"] },
