...
const scenes: readonly StoryScene[] = [
  ...
  { id: 3, title: "Repeated-diagnosis threshold", persona: "Teacher · Learning Product Owner", time: "After three PRODUCT runs", route: "?view=studio&section=patterns&embedded=1", required: ["PATTERN_THRESHOLD_REACHED"], proves: "A configurable repeated-diagnosis signal can invite teacher review without claiming automated pattern discovery.", initialExplanation: "The repository begins empty and aggregates only PRODUCT diagnosis evidence." },
