...
describe("AgentTraceRepository", () => {
  it("persists completed model and tool observations across repository re-instantiation", async () => {
    ...
    await repository.start({ traceId: "trace-1", request: { conversationId: "c-1", inputOrigin: "USER_INPUT", runPurpose: "PRODUCT", messages: [{ role: "user", content: "question" }] }, provider: "deepseek", model: "configured", thinkingMode: "disabled", prompt: { version: "1", contentHash: "prompt-hash" }, capabilityRegistry: { version: "1", contentHash: "registry-hash" }, toolDefinitions: { version: "1", contentHash: "tools-hash" }, startedAt: "2026-07-16T10:00:00.000Z" });
