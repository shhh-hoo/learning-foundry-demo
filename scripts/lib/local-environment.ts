const allowed = new Set(["DEEPSEEK_API_KEY", "DEEPSEEK_MODEL", "DEEPSEEK_BASE_URL", "DEEPSEEK_THINKING_MODE", "TRACE_STORE_DIR", "DIAGNOSIS_TRACE_STORE_DIR", "AGENT_EVAL_STORE_DIR"]);
